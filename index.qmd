...
**Reality (Panel 1):** The original image represents the true population—the complete picture of what we want to understand.
...
**Selection Bias (Panel 3):** The letter "S" represents a systematic pattern of missing data. Just like selection bias in real research, this isn't random—it follows a specific pattern that excludes certain parts of the population.
